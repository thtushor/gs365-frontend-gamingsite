...
const MobileNav = () => {
  ...
  return (
    <>
      {/* Bottom Navigation */}
      <div className="md:hidden  flex fixed bottom-0 w-full z-[999999] footer-menu-mobile-screen !mb-0 !pb-0">
        <div className="w-full bg-[#00623b]  mx-auto rounded-none footer-menu-mobile">
