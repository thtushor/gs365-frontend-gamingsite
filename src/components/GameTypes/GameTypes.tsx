...
export const GameTypes = () => {
    ...
    return <div className='flex flex-col p-2 gap-4 items-start py-10'>
<div className='flex overflow-auto gap-1 '>
        {
            gametypes.map((item) => (
                <div key={item?.id} className={`hover:bg-[#2a3254] cursor-pointer  relative w-[50px] py-4  ${selected === item?.id ? "gametype-box bg-[#2a3254]":"bg-[#222843]"}`} onClick={()=>{
                    setSelected(item?.id)
                }}>
    ...
    <div  id="nav-title" className="content-title flex item-center"><h2 className="ng-star-inserted"><span className="ng-star-inserted">Sports</span></h2></div>
    <div className='game-types--card--container'>
    <ul>
      <li className="ng-star-inserted" data-web-category-type="GAME" data-game-type="4" data-vendor-code="CRICKET">
        <a >
          <img
            loading="lazy"
            alt="icon-exchange"
      ...
      <li className="ng-star-inserted" data-web-category-type="GAME" data-game-type="4" data-vendor-code="Saba">
        <a >
          <img
            loading="lazy"
            alt="icon-sportbook"
      ...
      <li className="ng-star-inserted" data-web-category-type="GAME" data-game-type="4" data-vendor-code="SBOv2" data-extra-data="football">
        <a >
          <img
            loading="lazy"
            alt="provider-sbov2"
      ...
      <li className="ng-star-inserted" data-web-category-type="GAME" data-game-type="4" data-vendor-code="AWCMHORSEBOOK">
        <a >
          <img
            loading="lazy"
            alt="icon-horsebook"
      ...
      <li className="ng-star-inserted" data-web-category-type="GAME" data-game-type="4" data-vendor-code="SBTech">
        <a >
          <img
            loading="lazy"
            alt="icon-sbtech"
      ...
      <li className="ng-star-inserted" data-web-category-type="GAME" data-game-type="4" data-vendor-code="CMD">
        <a >
          <img
            loading="lazy"
            alt="icon-cmd"
      ...
      <li className="ng-star-inserted" data-web-category-type="GAME" data-game-type="4" data-vendor-code="AWCMRWB">
        <a >
          <img
            loading="lazy"
            alt="icon-awcmrwb"
      ...
      <li className="ng-star-inserted" data-web-category-type="GAME" data-game-type="32" data-vendor-code="NST">
        <a >
          <img
            loading="lazy"
            alt="icon-nst"
      ...
      <li className="ng-star-inserted" data-web-category-type="GAME" data-game-type="4" data-vendor-code="AWCMPINNACLE">
        <a >
          <img
            loading="lazy"
